...
// insert the post into the database
    ...
    $meta_fields = array(
        ...
        'house_number' => $vistor_details['hnumber'],
   ...
   foreach($meta_fields as $meta_key => $value){
    ...
    echo "<h2>Your booking Is Sucussesful.. Our agent will contact you</h2>";
?>
<?php  ?>
<!--ConfirmBookin-->
    ...
    <div class="container">
        <div class="bookingconfirm-wrap">
            <div class="bookingconfirm-room-details">
                ...
                <ul>
                    <li><strong>Dates : </strong><?php echo selected_dates_range($booking_details['bookingdate']); ?></li>
                    <li><strong>Nights : </strong><?php echo $booking_details['promotionnights'];  ?></li>
                    <li><strong>Persons : </strong><?php echo $booking_details['persons'];  ?></li>
                </ul>
            </div>
            ...
            <div class="bookingconfirm-Personal-details">
               <h2>Personal Details</h2>
                ...
                <ul>
                    ...
                    <li><strong>Title :</strong> <?php echo $vistor_details['company_name']; ?></li>
                    <?php endif; ?>
                    <li><strong>Naam :</strong> <?php echo $vistor_details['firstname']; ?><?php echo $vistor_details['middlename']; ?><?php echo $vistor_details['lastname']; ?></li>
                    <li><strong>Postcode :</strong> <?php echo $vistor_details['postcode']; ?></li>
                    <li><strong>Huisnummer :</strong> <?php echo $vistor_details['hnumber']; ?></li>
                    <li><strong>straat :</strong> <?php echo $vistor_details['street']; ?></li>
                    <li><strong>Woonplaats :</strong> <?php echo $vistor_details['city']; ?></li>
                    <li><strong>Land :</strong> <?php echo $vistor_details['country']; ?></li>
                    <li><strong>Telefoonnummer :</strong> <?php echo $vistor_details['phone']; ?></li>
                    <li><strong>E-Mailadress :</strong> <?php echo $vistor_details['vemail']; ?></li>
                    <li><strong>Geboortedatum :</strong> <?php echo $vistor_details['DOB']; ?></li>
                </ul>
            </div> 
              <div class="bookingconfirm-Fare-details">
               <h2>Total Fare <strong><?php echo get_booking_total($booking_details['booking_price'],$booking_details['promotionnights'],$room_details['upsells']); ?></strong></h2>
                <hr>
                ...
                <form action="" method="post">
                    <div class="input_wrap vtype">
                        <span class="input-radio">
                            ...
                            <label for="private_pt">Prive</label>
                        </span>
                        <span class="input-radio">
                            <input type="radio" id="company_pt" name="person_type" value="company">
                            <label for="company_pt">Zakelijk</label>
                        </span>
                    ...
                    <div class="input_wrap">
                        ...
                        <label for="terms_pt">Agree Terms</label>
                    </div>
                    <div class="input_wrap">
                        <input type="checkbox" id="registration_pt" name="registration">
                        <label for="registration_pt">newsletter registration</label>
                    </div>
            ...
            <div class="personaldetails-right">
                ...
                <div class="room-info">
                    <div class="booking-info">
                        <h3>UW Boeking bij <?php echo get_hotel_name(); ?></h3>
                    ...
                    <div class="total-price-blk clearfix">
                        <strong class="upsell-price-blk-left">Total</strong>
                    ...
                    <div class="room clearfix">
                        ...
                        <div class="room-info">
                            ...
                            <div class="room-info-meta">
                                <div><strong>m2:</strong><?php echo get_field('rm_size',$room); ?></div>
                                <div><strong>Persons:</strong><?php echo get_field('rm_persons',$room); ?></div>
                            </div>
                    ...
                    <div class="upsell clearfix">
                        ...
                        <div class="upsell-info">
                            ...
                            <div class="upsell-info-meta">
                                <strong>Price :</strong><?php echo get_field('upsell_price',$upsell); ?>
                            </div>
    ...
    <div class="container">
        <div class="section-promotion-info">
            ...
            <div class="package-details">
                <strong>Dit arrangement bevat:</strong>
        ...
        <div class="section-promotion-avialbility">
            ...
            <div class="promotion-details">
                ...
                <div class="start_date"><strong>Start Date: </strong><?php echo get_field('pm_sdate'); ?></div>
                <div class="end_date"><strong>End Date: </strong><?php echo get_field('pm_edate'); ?></div>
            </div>
        </div>
